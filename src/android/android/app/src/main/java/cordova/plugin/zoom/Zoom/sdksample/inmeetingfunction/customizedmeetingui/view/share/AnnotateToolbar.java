package cordova.plugin.zoom.Zoom.sdksample.inmeetingfunction.customizedmeetingui.view.share;
...
public class AnnotateToolbar extends FrameLayout implements IColorChangedListener, View.OnClickListener{
	...
	private void initAnnotateView(Context context)
	{
        ...
        ColorSelectedImage mColorImage = (ColorSelectedImage) mColorIndicator.findViewById(R.id.colorImage);
