package cordova.plugin.zoom.Zoom.sdksample.inmeetingfunction.customizedmeetingui.rawdata;
...
public class VirtualShareSource implements ZoomSDKShareSource {
    ...
    private String mVideoFile_Full = "/sdcard/Android/data/us.zoom.sdkexample/files/football_1920x1080_i420_full.yuv";
    private String mVideoFile_LIMITED = "/sdcard/Android/data/us.zoom.sdkexample/files/football_1920x1080_i420.yuv";
...
//        String videoPath = mContext.getExternalFilesDir(null) + File.separator + filename;
    ...
    @Override
    public void onStartSend(ZoomSDKShareSender sender) {
