 ...
 */
public class InitAuthSDKHelper implements cordova.plugin.zoom.Zoom.sdksample.initsdk.AuthConstants, ZoomSDKInitializeListener {
    ...
    private cordova.plugin.zoom.Zoom.sdksample.initsdk.InitAuthSDKCallback mInitAuthSDKCallback;
     ...
     * init sdk method
     */
    public void initSDK(Context context, cordova.plugin.zoom.Zoom.sdksample.initsdk.InitAuthSDKCallback callback) {
        if (!mZoomSDK.isInitialized()) {
            ...
            initParams.domain= cordova.plugin.zoom.Zoom.sdksample.initsdk.AuthConstants.WEB_DOMAIN;
