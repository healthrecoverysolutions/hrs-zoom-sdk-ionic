...
import cordova.plugin.zoom.Zoom.sdksample.inmeetingfunction.customizedmeetingui.audio.MeetingAudioCallback;
import cordova.plugin.zoom.Zoom.sdksample.inmeetingfunction.customizedmeetingui.audio.MeetingAudioHelper;
import cordova.plugin.zoom.Zoom.sdksample.inmeetingfunction.customizedmeetingui.bo.BOEventCallback;
import cordova.plugin.zoom.Zoom.sdksample.inmeetingfunction.customizedmeetingui.emoji.EmojiReactionCallback;
import cordova.plugin.zoom.Zoom.sdksample.inmeetingfunction.customizedmeetingui.other.MeetingCommonCallback;
import cordova.plugin.zoom.Zoom.sdksample.inmeetingfunction.customizedmeetingui.rawdata.RawDataRender;
import cordova.plugin.zoom.Zoom.sdksample.inmeetingfunction.customizedmeetingui.remotecontrol.MeetingRemoteControlHelper;
import cordova.plugin.zoom.Zoom.sdksample.inmeetingfunction.customizedmeetingui.share.MeetingShareCallback;
import cordova.plugin.zoom.Zoom.sdksample.inmeetingfunction.customizedmeetingui.share.MeetingShareHelper;
import cordova.plugin.zoom.Zoom.sdksample.inmeetingfunction.customizedmeetingui.user.MeetingUserCallback;
import cordova.plugin.zoom.Zoom.sdksample.inmeetingfunction.customizedmeetingui.video.MeetingVideoCallback;
import cordova.plugin.zoom.Zoom.sdksample.inmeetingfunction.customizedmeetingui.video.MeetingVideoHelper;
import cordova.plugin.zoom.Zoom.sdksample.inmeetingfunction.customizedmeetingui.view.MeetingOptionBar;
import cordova.plugin.zoom.Zoom.sdksample.inmeetingfunction.customizedmeetingui.view.MeetingWindowHelper;
import cordova.plugin.zoom.Zoom.sdksample.inmeetingfunction.customizedmeetingui.view.RealNameAuthDialog;
import cordova.plugin.zoom.Zoom.sdksample.inmeetingfunction.customizedmeetingui.view.adapter.AttenderVideoAdapter;
import cordova.plugin.zoom.Zoom.sdksample.inmeetingfunction.customizedmeetingui.view.share.AnnotateToolbar;
import cordova.plugin.zoom.Zoom.sdksample.inmeetingfunction.customizedmeetingui.view.share.CustomShareView;
import cordova.plugin.zoom.Zoom.sdksample.inmeetingfunction.livetranscription.LiveTranscriptionRequestHandleDialog;
import cordova.plugin.zoom.Zoom.sdksample.ui.APIUserStartJoinMeetingActivity;
import cordova.plugin.zoom.Zoom.sdksample.ui.BreakoutRoomsAdminActivity;
import cordova.plugin.zoom.Zoom.sdksample.ui.InitAuthSDKActivity;
//import cordova.plugin.zoom.Zoom.sdksample.ui.LoginUserStartJoinMeetingActivity;
import cordova.plugin.zoom.Zoom.sdksample.ui.LoginUserStartJoinMeetingActivity;
import cordova.plugin.zoom.Zoom.sdksample.ui.UIUtil;
...
import com.hrs.clinician.MainActivity;
...
public class MyMeetingActivity extends FragmentActivity implements View.OnClickListener, MeetingVideoCallback.VideoEvent,
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (null != getIntent().getExtras()) {
            ...
            rootActivity = getIntent().getExtras().getString("rootActivity");
        }
...
//        MeetingWindowHelper.getInstance().showMeetingWindow((Activity) getBaseContext());
        refreshToolbar();
    }
...
//            MeetingWindowHelper.getInstance().showMeetingWindow(MyMeetingActivity.t);
        } else {
...
//            MeetingWindowHelper.getInstance().showMeetingWindow();
//        } else {
//            MeetingWindowHelper.getInstance().hiddenMeetingWindow(true);
//        }
        MeetingWindowHelper.getInstance().showMeetingWindow(MeetingWindowHelper.getInstance().getMainActivity());
    }
...
//        try {
//            Log.d("AB", "rootActivity" + rootActivity);
//            clz = Class.forName(rootActivity);
//            Log.d("AB","clz"+ clz);
//
//        } catch (ClassNotFoundException e) {
//            throw new RuntimeException(e);
//        }
        Activity mainActivity = MeetingWindowHelper.getInstance().getMainActivity();
        clz = mainActivity.getClass();
//        clz = InitAuthSDKActivity.class;
        Log.d("AB","clz"+ clz);
    ...
    private void showPsswordDialog(final boolean needPassword, final boolean needDisplayName, final InMeetingEventHandler handler) {
        ...
        builder = new Dialog(this,com.hrs.clinician.R.style.ZMDialog);
