...
let AddPatientPage = class AddPatientPage {
    constructor(alertCtrl, route, navCtrl, user, environment, settings, toastCtrl, menuCtrl, translateService, patientProfileService, logger) {
    ...
    configureSubgroupBehavior() {
        ...
        if (userSubgroups.length)
            this.subgroups = this.subgroups.filter((subgroup) => userSubgroups.includes(subgroup));
            ...
            if (allCustomFields) {
                ...
                for (let i = 0; i < allCustomFields.length; i++) {
                    ...
                    if (customField.patientsetup) {
                        this.newPatient[this.customAttributeSetting].push(Object.assign({}, customField));
                    }
                }
    ...
    initializeSecondPage(isBack) {
        ...
        if (this.hasSubgroup) {
            ...
            let subgroupControl = this.subgroupRequired ? new _angular_forms__WEBPACK_IMPORTED_MODULE_8__["FormControl"](this.newPatient.subgroup || '', _angular_forms__WEBPACK_IMPORTED_MODULE_8__["Validators"].required) : new _angular_forms__WEBPACK_IMPORTED_MODULE_8__["FormControl"](subgroupValue);
            controls['subgroup'] = subgroupControl;
        }
        this.addPatientForm = new _angular_forms__WEBPACK_IMPORTED_MODULE_8__["FormGroup"](controls);
        this.addPatientFormKeys = Object.keys(this.form);
    }
    initializeCustomFieldsPage(isBack) {
        // cancel any previous toast instances
        if (this.formErrorToast) {
            this.formErrorToast.dismissAll();
        }
        ...
        this.newPatient[this.customAttributeSetting].forEach((field, i) => {
            if (field.required) {
                controls['custom_' + i] =
                    new _angular_forms__WEBPACK_IMPORTED_MODULE_8__["FormControl"](this.newPatient[this.customAttributeSetting][i].value || '', _angular_forms__WEBPACK_IMPORTED_MODULE_8__["Validators"].required);
            }
            else {
                controls['custom_' + i] =
                    new _angular_forms__WEBPACK_IMPORTED_MODULE_8__["FormControl"](this.newPatient[this.customAttributeSetting][i].value || '');
            }
        });
        this.addPatientForm = new _angular_forms__WEBPACK_IMPORTED_MODULE_8__["FormGroup"](controls);
        this.addPatientFormKeys = Object.keys(this.form);
    ...
    getCustomFieldValue(customFieldValue, customFieldType) {
    ...
    throwSuccessToast() {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function* () {
            let successToast = yield this.toastCtrl.create({
            ...
            return yield successToast.present();
        });
    }
    createRequestBody() {
        if (this.hasCustomFields) {
    ...
    throwErrorAndResetPage(message) {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function* () {
            message = message ? ': ' + message : '.';
            let errorMessage = yield this.toastCtrl.create({
    ...
    addSubgroup(hrsid, subgroup) {
        const saveSubgroupRequest = { subgroup: subgroup };
...
// ////////////////////////////////////////////////////////
class AddShadowPartsToSelectBox {
    constructor(el) {
        this.el = el;
...
AddShadowPartsToSelectBox.ctorParameters = () => [
...
//# sourceMappingURL=add-patient-add-patient-module-es2015.js.map