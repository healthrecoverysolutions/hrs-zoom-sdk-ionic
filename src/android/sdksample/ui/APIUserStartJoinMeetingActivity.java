...
import cordova.plugin.zoom.Zoom.sdksample.startjoinmeeting.apiuser.ApiUserStartMeetingHelper;
...
public class APIUserStartJoinMeetingActivity extends Activity implements AuthConstants, MeetingServiceListener, View.OnClickListener {
    ...
    public void onClickBtnStartMeeting() {
        ...
        int ret = -1;
        if (vanityId.length() != 0) {
            ret = ApiUserStartMeetingHelper.getInstance().startMeetingWithVanityId(this, vanityId,zak);
        } else {
            ret = ApiUserStartMeetingHelper.getInstance().startMeetingWithNumber(this, meetingNo,zak);
        }
