...
import cordova.plugin.zoom.Zoom.sdksample.initsdk.AuthConstants;
...
import cordova.plugin.zoom.Zoom.sdksample.startjoinmeeting.LoginUserStartMeetingHelper;
import cordova.plugin.zoom.Zoom.sdksample.startjoinmeeting.joinmeetingonly.JoinMeetingHelper;
...
public class LoginUserStartJoinMeetingActivity extends Activity implements AuthConstants, MeetingServiceListener, ZoomSDKAuthenticationListener {
    ...
    public void onClickSettings(View view) {
        Intent intent = new Intent(this, cordova.plugin.zoom.Zoom.sdksample.ui.MeetingSettingActivity.class);
        startActivity(intent);
    }
    ...
    private void showInitView() {
        mEdtMeetingPassword.postDelayed(new Runnable() {
            ...
            public void run() {
                if (ZoomSDK.getInstance().isInitialized()) {
                    Intent intent = new Intent(LoginUserStartJoinMeetingActivity.this, InitAuthSDKActivity.class);
                    startActivity(intent);
                }
                finish();
            }
