...
1. All cloud whiteboard icons/languages should be managed by zdcRes.bundle

2. If any changes for the zdcRes resources, please re-build the target 'zdcRes' in annoter.xcodeproj.
